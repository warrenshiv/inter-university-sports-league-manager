...
const Lender = ({ lender }) => {
  const { id, name, skills, email, creditScore, principal, imageUrl } = lender;

  const lenderPrincipal = window.auth.principalText;
...
Lender.propTypes = {
  lender: PropTypes.instanceOf(Object).isRequired,
};
